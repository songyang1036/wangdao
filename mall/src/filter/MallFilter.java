 ...
 * Time: 10:48
 */
@WebFilter(filterName = "MallFilter",urlPatterns = "/api/mall/*")
public class MallFilter implements Filter {
    ...
    public void doFilter(ServletRequest req, ServletResponse resp, FilterChain chain) throws ServletException, IOException {
        ...
        url = url.replace("/api/mall/goods/","");
...
//        }
        ...
        if("GET".equals(request.getMethod()) || "POST".equals(request.getMethod())){
            ...
            if((!"getType".equals(url)) && (!"getGoodsByType".equals(url)) && (!"searchGoods".equals(url)) && (!"getGoodsInfo".equals(url)) && (!"getGoodsMsg".equals(url)) && (!"getGoodsComment".equals(url))&&(name == null))
            {
